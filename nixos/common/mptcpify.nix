...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    # INVALID, which the NixOS firewall then drops.  Accept INVALID TCP
    # packets so that MP_JOIN handshakes complete.  The TCP stack will RST
    # truly invalid connections on its own.
